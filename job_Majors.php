...
<h3 style="color:rgb(255,255,255)">Search for jobs:</h3>
<form style="color:rgb(255,255,255)" action="job_Majors.php" method="post">
...
if (isset($_POST['submit'])) 
{
    ...
    $command = 'python3 job_Majors.py ' . $major;
